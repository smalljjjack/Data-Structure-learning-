...
public class DList extends List {
  ...
  public void insertFront(Object item) {
	  if(this.head.next.isValidNode()){
		  DListNode temp = new DListNode(item, this, head, head.next);
		  head.next.prev = temp;
		  head.next = temp;
		  size++;
	  }else{
		  DListNode temp = new DListNode(item, this, head, head);
		  head.next = temp;
		  head.prev = temp;
		  size++;
	  }
  ...
  public void insertBack(Object item) {
	  if(this.head.next.isValidNode()){
		  DListNode temp = new DListNode(item, this, head.prev, head);
		  head.prev.next = temp;
		  head.prev = temp;
		  size++;
	  }else{
